...
//   - kernel-manifests.generated.ts 镜像 + 生成器已随 R4-4b 全部插件退役删除
//     （2026-09-05，kernel-capability-d4-handle-design.md——schema 真源回 TS zod，
//     INVARIANTS #8 原版；登记项同步清）
...
//   - facts.generated.md（文档事实单一真源，doc-facts；文档面大重构 P0 挂入）
...
const generators = [
  ...
  { name: 'doc-facts', script: path.join(ROOT, 'scripts', 'doc-facts.cjs') },
];
