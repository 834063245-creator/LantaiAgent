...
// composition/asset-renderers — Agent 资产块首发表现原语（WO-6/WO-8）。
//
// 纪律（协议 §2.9）：
...
//
// 这里的 def.kind 是「表现原语名」（grid/chart/metric/media/graph/tree/html/form），
...
export function assetPresentationDefs(): BlockRendererContribution[] {
  return [
    { id: 'builtin/grid', kind: 'grid', component: GridBody },
    { id: 'builtin/chart', kind: 'chart', component: ChartBody },
    { id: 'builtin/metric', kind: 'metric', component: MetricBody },
    { id: 'builtin/media', kind: 'media', component: MediaBody },
    { id: 'builtin/graph', kind: 'graph', component: GraphTreeBody },
    { id: 'builtin/tree', kind: 'tree', component: GraphTreeBody },
    { id: 'builtin/html', kind: 'html', component: HtmlBody },
    { id: 'builtin/form', kind: 'form', component: FormBody },
  ];
}
