...
//
// 出厂查看器表（渲染面补全 B1，2026-09-23）——B1：图片 / 视频（自 MediaBody 迁入，
// 行为等价）+ 音频（新增格式）。后续批次逐条增补（代码 / PDF / Office / 数据 /
// 归档 / 3D / 字体 / 电子书 / 科研 / 字幕 / 邮件 / Markdown 目录）。
//
...
export const BUILTIN_VIEWERS: readonly ViewerDef[] = [imageViewer, videoViewer, audioViewer];
