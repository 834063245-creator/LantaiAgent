...
//
// 挂载：compose-dock-plugin 以 ctx.overlays 贡献行注册（slot:'right-edge'），
// 由 PaperPanel 渲染在右缘；经 paper/overlay-context 取活跃流区派生数据与
// flyToPoint 动作。几何计算在 paper/toc（纯函数，单测覆盖）。

import { memo, useMemo } from 'react';
import { usePaperDock, usePaperRegion } from '../../paper/overlay-context';
import { buildTurnAnchors, nearestAnchorAt, type TocRange, viewportMarker } from '../../paper/toc';
