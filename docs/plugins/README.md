...
兰台的 39 个出厂插件（7 seam 供应商 + 5 既有 + 16 工具域 + 2 段贡献 + plan-mode + goal-mode + state-hooks + compaction + multiagent-comm + paper-renderers + sessions-home + ask-cards + bundled-engine）——
