...
| `builtin_service_plugins` | 内核插件数（BUILTIN_PLUGINS 表） | **14** | `src-ui/src/plugins/service-plugins.ts` |
| `factory_products` | 出厂产物数（builtin-roster.json） | **36** | `src-ui/src/plugins/builtin-roster.json` |
...
| `first_party_plugins` | 第一方插件总数（内核 + 出厂产物） | **50** | `src-ui/src/plugins/service-plugins.ts + src-ui/src/plugins/builtin-roster.json` |
