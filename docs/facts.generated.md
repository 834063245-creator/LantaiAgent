...
| `builtin_service_plugins` | 内核插件数（BUILTIN_PLUGINS 表） | **13** | `src-ui/src/plugins/service-plugins.ts` |
...
| `first_party_plugins` | 第一方插件总数（内核 + 出厂产物） | **49** | `src-ui/src/plugins/service-plugins.ts + src-ui/src/plugins/builtin-roster.json` |
