...
| `factory_products` | 出厂产物数（builtin-roster.json） | **37** | `src-ui/src/plugins/builtin-roster.json` |
...
| `first_party_plugins` | 第一方插件总数（内核 + 出厂产物） | **52** | `src-ui/src/plugins/service-plugins.ts + src-ui/src/plugins/builtin-roster.json` |
