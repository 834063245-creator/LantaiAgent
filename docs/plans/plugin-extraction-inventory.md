...
**2026-09-26 基线**（批 9h-3 后重测）：红 **3 产物 / 6 文件 / 2,369 行**（§1 的 5 条 + §2.5 的 `type-tokens`；批 9d 销 Provider 家族 8 件 2,740 行 · 9g-1 销 `prompt-sections` 244 · 9g-2 销 `show-asset` 294 + `asset-store` 137 + `confirm-registry` 80 · 9h-1 销 `blueprint.ts` 410 · 9h-2 销 `default-loop.ts` 469 · 9h-3 销 `skills.ts` 377 + `builtin-skills.ts` 358）；
绿 **120 平台 + 120 已认领**；灰 **52 文件 / 15,355 行**（批 8 把渲染面判据层收成 `shared`：
...
15,711 行；**9h-3 技能域整件随包** ⇒ 灰区 53 → **52 文件 / 15,355 行**、已认领 119 → 120）。
