...
| **多模态图片链路（附图入卷）** | 3-5 天 | **plan 定稿待施工**（2026-09-08 立项，两问调查问题 1：五断点全断 + DSH 参照研究收官；引用传递/请求期解析/预算降级/能力门禁三面/markdown 远端图——B1 底座→B2 采集→B3 发送→B4 渲染→B5 配置批序）——见 [`multimodal-image-plan.md`](multimodal-image-plan.md) |
