...
| `use-region-activation.ts` | 激活/自动选中 | settle 三道闸、activateRegion、adopt/manualGuard、自动选中 tick、键盘走卷（1970-1997 + 2066-2134 → 键盘独立见下） |
...
- 真机验收一项：画布平移/缩放/拖块钉住/抽纸条/自动选中/小地图拖拽六手势无回归（用户跑）。
