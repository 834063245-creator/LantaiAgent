...
> **已归档（2026-09-16 · 文档面重构）**——L1-L4 落地 + L5 文档收尾 + L5b crate 化满偿（2026-08-25）；**真机验收四项已闭**：图谱相关项随 2026-09-09 图谱内置接线全量退役作废、③④ 随会话归属反转作废（逐行见 `docs/plans/README.md` 真机欠账表）。现状指针：`ARCHITECTURE.md` §9（项目结构）+ `CONVENTIONS.md` §2.4。
