...
> **已归档（2026-09-16 · 文档面重构）**——竣工（2026-09-06 单 commit 落地，门禁全绿；PaperPanel 3253 行按域拆 16 个 hook 文件，纯行为保持机械批）。**余真机验收一项**（本页 §6）仍待用户跑。现状指针：`docs/plans/paper-shell/README.md`；现状入口 `docs/plans/README.md`。
