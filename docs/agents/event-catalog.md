...
| `step/end` | emit | StepEndPayload | `src/agent/events.ts:54` | `src/agent/agent-loop/default-loop.ts:353` · `src/agent/agent-loop/default-loop.ts:445` | — |
...
| `turn/end` | emit | TurnEndPayload | `src/agent/events.ts:52` | `src/agent/agent-loop/default-loop.ts:452` | — |
