...
| `ctx.renderers` | `RenderersService` | `src/composition/renderer-service.tsx` | — | 3 文件 |
...
- 默认实现 / 贡献者 id：—
- 消费面（3）：`src/app/panels/PaperPanel.tsx` · `src/composition/asset-renderers.tsx` · `src/plugins/loader.ts`
