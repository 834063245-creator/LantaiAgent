...
禁止用 `cargo build --release` 代替桌面发布验证。当前实测基线：engine 697 tests（696 passed / 1 ignored）· src-tauri 370+14 tests（bin 全绿；2026-08-20 S4 竣工实测）· 前端 1530 passed / 1 skipped（2026-08-22 paper-shell V3b 竣工实测；convergence 零漂移）。
