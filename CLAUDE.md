...
禁止用 `cargo build --release` 代替桌面发布验证。当前实测基线：engine 697 tests（696 passed / 1 ignored）· src-tauri 343 tests（bin 全绿）· 前端 1338 passed / 1 skipped（共 1339，136 文件；2026-08-20 组合架构 S1 竣工后）。
