...
- **方言贡献道**（2026-08-27 插件化收口）：`ctx.providers.register({ id, kind, create })` 可覆盖内核 anthropic/openai 方言（后注册胜）；未知 kind 响亮报错不再静默跌 openai。详见 provider-system-spec「追加裁决 2026-08-27」
